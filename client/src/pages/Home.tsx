...
function exportChat(messages: StoredChatMessage[], format: "json" | "text") {
  ...
  downloadChat(`omega-chat-${stamp}.txt`, text, "text/plain;charset=utf-8");
}
